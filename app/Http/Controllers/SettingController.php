...
class SettingController extends Controller
{
    public function index()
    {
        ...
        $settings = [
            ...
            'app_logo' => WebSetting::getValue('app_logo'),
    ...
    public function update(Request $request)
    {
        ...
        if ($request->hasFile('app_logo')) {
            ...
            $oldLogo = WebSetting::getValue('app_logo');
            if ($oldLogo && file_exists(public_path($oldLogo))) {
                @unlink(public_path($oldLogo));
            }
            
            WebSetting::setValue('app_logo', 'uploads/' . $filename, 'string', 'Logo aplikasi');
        }
        ...
        Activity::create([
            ...
            'description' => 'Mengupdate pengaturan web',
